...
const Database: NextPage = () => {
  ...
  const onGeneratePGRDocumentTest = () => {
    ...
    return createDoc.mutateAsync({
      ...
      riskGroupId: '929311d9-5f6c-4773-b071-58af8285beff', // Teste Bonito
      ...
      workspaceId: 'f588207b-ac7b-4b63-9d85-cd5753f9b288', // Teste Bonito
      ...
      companyId: 'd1309cad-19d4-4102-9bf9-231f91095c20', // Teste Bonito
    });
  };
