...
const Database: NextPage = () => {
  ...
  const onGeneratePGRDocumentTest = () => {
    ...
    return createDoc.mutateAsync({
      ...
      riskGroupId: '06d40eac-254b-4f47-8a05-309fbfcdea11', // MARCELO ACADEMIA
      workspaceId: 'a942957a-bf2a-40e4-ac9d-dd4976a4b79c', // MARCELO ACADEMIA
      companyId: '3af70a3f-be5b-4cda-95f5-a4d469349ca4', // MARCELO ACADEMIA
