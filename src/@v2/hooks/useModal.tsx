...
export enum ModalKeyEnum {
  ...
  FORM_APPLICATION_SHARE = 'FORM_APPLICATION_SHARE',
  FORM_APPLICATION_DELETE_CONFIRM = 'FORM_APPLICATION_DELETE_CONFIRM',
  FORM_APPLICATION_GRANT_REMINDER_LIMIT = 'FORM_APPLICATION_GRANT_REMINDER_LIMIT',
