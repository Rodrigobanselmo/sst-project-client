...
export const FormParticipantsGroupedByEstablishmentHierarchy = ({
  rows,
  config,
  isLoading,
  fetchCap,
            ...
            groups.map((est) => (
              <Fragment key={est.establishmentLabel}>
                ...
                {est.hierarchyGroups.map((group) => (
                  <TableRow
                    key={`${est.establishmentLabel}-${group.groupLabel}`}
                  >
                    <TableCell sx={{ pl: 4 }}>
                    ...
                    <TableCell align="right">
                      {formatPercent(group.responseRatePercent)}
                    </TableCell>
                    <TableCell>
                      <ResponseRateBar percent={group.responseRatePercent} />
                    </TableCell>
                  </TableRow>
                ))}
              </Fragment>
