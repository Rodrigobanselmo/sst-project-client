...
export const PublicFormAnswerPage = () => {
  ...
  const onSubmit = async (data: FormAnswers) => {
    ...
    const requiredQuestions = currentGroupQuestions.filter(question => question.required);
  ...
  const sectionTitle = currentStep === 0 ? (currentGroup?.name || publicFormApplication.name) : publicFormApplication.name ;
          ...
          <SFlex direction="column" gap={10}>
              ...
              <Box sx={{
                ...
                borderTop: '4px solid #1976d2'
                  ...
                  <Typography
                    variant="h1"
                    fontSize={24}
                    sx={{  color: '#333', fontWeight: 600, marginBottom: 12 }}
                  >
                    {sectionTitle}
                  </Typography>
                  {currentGroup.description && <HtmlContentRenderer content={currentGroup.description} fontSize={14} />}
              </Box>
            )}
            ...
            <Box sx={{ 
              ...
              <SButton
                ...
                text={currentStep === totalSteps - 1 ? 'Enviar Resposta' : 'Próximo'}
                color='primary'
                minWidth={120}
              />
            </Box>
