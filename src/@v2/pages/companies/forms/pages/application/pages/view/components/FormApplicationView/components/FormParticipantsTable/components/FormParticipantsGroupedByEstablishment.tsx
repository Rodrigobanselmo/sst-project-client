...
export type { EstablishmentAggregateRow } from '@v2/models/form/helpers/form-participants-aggregate-by-establishment';
  ...
  if (isLoading) {
    return (
      <Typography color="text.secondary" sx={{ py: 3 }}>
        Carregando agrupamento por estabelecimento…
      </Typography>
    );
  }
    ...
    <Box sx={{ mb: 2 }}>
      {isPartialFetch ? (
        <Alert severity="warning" sx={{ mb: 2 }}>
          ...
          os primeiros {fetchCap} registros carregados; os totais por estabelecimento
        ...
        <TableBody>
          {aggregates.length === 0 ? (
            ...
            aggregates.map((g) => {
              ...
              return (
                <TableRow key={g.establishmentLabel}>
                  <TableCell>
                    <Typography fontWeight={600}>{g.establishmentLabel}</Typography>
                  </TableCell>
