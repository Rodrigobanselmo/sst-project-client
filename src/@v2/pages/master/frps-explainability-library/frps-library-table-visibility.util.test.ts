...
function row(
  ...
  return {
    ...
    equivalenceId: partial.equivalenceId ?? null,
    ...
    catalogUsability: partial.catalogUsability ?? 'USABLE',
    generateable: partial.generateable ?? origin === 'GLOBAL',
    isInvalidSystemReference: partial.isInvalidSystemReference ?? false,
