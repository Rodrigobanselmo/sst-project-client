...
import { DatePickerForm } from 'components/molecules/form/date-picker';
...
import { ProfessionalInputSelect } from 'components/organisms/inputSelect/ProfessionalSelect';
      ...
      >
        ...
        <Box mt={10}>
          <DatePickerForm
            ...
            control={control}
            defaultValue={companyGroupData.esocialStart}
            name="esocialStart"
            sx={{ maxWidth: 240 }}
          />
        </Box>
