...
import { useUserFormOld } from './hooks/useUserForm';
import { STBox } from './styles';
import { CouncilShow } from '../UserForm/CouncilShow/CouncilShow';

export const UserFormOld = (props: BoxProps & { onlyEdit?: boolean }) => {
  const {
    onSave,
    loading,
    handleSubmit,
