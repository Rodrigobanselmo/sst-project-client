...
export const SendEvent2210ESocialTable: FC<
  { children?: any } & BoxProps & {
      isLoading?: boolean;
      rowsPerPage?: number;
      onSelectData?: (company: IEvent2210) => void;
      selectedData?: IEvent2210[];
      events: IEvent2210[];
      company?: ICompany;
    }
> = ({
  ...
  const onSelectRow = (company: IEvent2210) => {
    if (isSelect) {
      onSelectData(company);
    }
  };

  const onViewXMl = (event: IEvent2210) => {
