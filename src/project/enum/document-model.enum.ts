...
export enum DocumentSectionChildrenTypeEnum {
  ...
  LEGAL_RESPONSIBLE_SIGNATURE = 'LEGAL_RESPONSIBLE_SIGNATURE',
  ...
  FRPS_PARTICIPATION_SUMMARY_TABLE = 'FRPS_PARTICIPATION_SUMMARY_TABLE',
  FRPS_PARTICIPATION_HIERARCHY_TABLE = 'FRPS_PARTICIPATION_HIERARCHY_TABLE',
  FRPS_INDICATORS_DISTRIBUTION_TABLE = 'FRPS_INDICATORS_DISTRIBUTION_TABLE',
  FRPS_METHOD_SCALES_TABLE = 'FRPS_METHOD_SCALES_TABLE',
  /** Alias legado de leitura — JSONs persistidos com o tipo anterior. */
  FRPS_COPSOQ_SCALES_TABLE = 'FRPS_COPSOQ_SCALES_TABLE',
  FRPS_PARTICIPATION_SUMMARY_CHART = 'FRPS_PARTICIPATION_SUMMARY_CHART',
  FRPS_PARTICIPATION_HIERARCHY_CHART = 'FRPS_PARTICIPATION_HIERARCHY_CHART',
  FRPS_INDICATORS_DISTRIBUTION_CHART = 'FRPS_INDICATORS_DISTRIBUTION_CHART',
  FRPS_METHOD_SCALES_CHART = 'FRPS_METHOD_SCALES_CHART',
  /** Alias legado de leitura — JSONs persistidos com o tipo anterior. */
  FRPS_COPSOQ_SCALES_CHART = 'FRPS_COPSOQ_SCALES_CHART',
}
